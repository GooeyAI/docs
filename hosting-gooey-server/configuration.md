---
icon: sliders
description: Every environment variable Gooey Server reads, with defaults.
---
...
See [Installation Guide § Functions runtime](installation/#functions-runtime-cloudflare-workers) for deployment instructions.
